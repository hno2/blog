---
author: Simon Klug
title: Workshop Regie
date: 2026-04-03
summary: Zusammenfassung des Regie-Workshops von LSS
publications_src: content/Theater/theater.bib
lang: de
---
...
!!!note "Brainwriting Motivation"
    ...
    **Interesse**: Was interessiert / verwirrt / stört mich an dem Stoff? </br>
    **Emotion**: Welches Bild/Gefühl kommt bei mir sofort? </br>
    **Ziel**: Was ist die Take-Home-Message (Moral) fürs Publikum?


Das Ziel besteht darin, deine ersten intuitiven und individuellen Gedanken ohne Anspruch auf Vollständigkeit festzuhalten, bevor Selbstzensur oder Gruppendenken einsetzen.
Deine Motivation kann entweder aus deinem persönlichen Interesse kommen und du suchst (oder schreibst) einen passenden Text, oder du hast einen Text, der dich begeistert, und findest anhand dessen heraus, was genau dein Interesse ist.

## Vor einer Szenenprobe - Szenenkonzept
### Textanalyse
Um das Konzept für eine Szene zu entwickeln, sollten deine persönliche Motivation und der vorhandene Text zusammenfinden.
Dazu analysierst du zunächst den Text.
...
### BIG IDEA
Die [BIG IDEA](https://www.duarte.com/blog/how-to-develop-the-best-big-idea-for-your-presentation/) (nach Nancy Duarte) ist der eine Satz, der den Kern eines Konzepts auf den Punkt bringt. Sie ist nicht eine Zusammenfassung,  sondern eine Behauptung oder das Thema/die Aussage, die ich vermitteln will.
...
Wenn die Antwort Nein ist: streichen. Häufig haben wir viele tolle Ideen, doch wenn wir alles hinzufügen, verwässern wir die Klarheit und es entstehen Längen, auch wenn du die Idee liebst.
Alles, was nicht auf deine Big Idea einzahlt, macht sie schwächer. Ein starkes Konzept entsteht nicht durch Hinzufügen, sondern durch konsequentes Weglassen. Das ist der Kern von *Kill your Darling*.
...
!!!note "Wie probe ich?"
    **Brauche ich Hilfe?**
    ...
    - Welche [Fortbildung/Workshop](https://amateurtheater-bw.de/kurse/) würde mir helfen? Von wem kann ich oder wir als Gruppe uns Wissen holen?
...
!!!note "Regiestile"
    ...
    **Textbasiert / dramaturgisch** Die Regie arbeitet eng am Text, Interpretation steht im Zentrum. 
    Vertreter: *Frank Castorf*, *Thomas Ostermeier*
...
Du kannst dazu die [[text-lernen| Übungen zum Textlernen]] nutzen. Hier wiederholen die Spielpartner mit verschiedenen Aufträgen den Text immer wieder ohne Emotion oder Deutung.  
...
Im nächsten Abschnitt schauen wir uns konkrete Methoden an. Der Hintergedanke ist immer ein ehrliches und offenes Interesse am Ergebnis, auch wenn der Weg vielleicht nicht direkt klar ist. Wir wollen eben nicht das Ergebnis vordenken, sondern schrittweise ein Ergebnis erspielen.

!!!note "Hinweis zu Aufgaben"
...
Ein Text sagt „Charakter sagt das wütend", also spielen wir Wut. Das Ergebnis aber fühlt sich oft falsch und unehrlich an und ist selten überraschend.
Indem wir Genres, Emotionen und Sprachstile bewusst oder noch besser konträr zum Text einsetzen, können wir mit diesen Gewohnheiten brechen. Sie zwingen uns dazu, uns neu an einer fremden Form zu orientieren. Plötzlich werden die Ziele, Beziehungen und Figuren klarer.
Das ist der eigentliche Grund für diese Übung: Wir wollen Klarheit über das, was deine Szene wirklich braucht.

!!!note "Genres/Emotion/Sprachstil"
    Spielt das Mini-Drama oder eine Mini-Szene mehrfach durch, startet mit jeweils nur einem Genre oder einer Emotion oder einem Sprachstil für alle.
    Spielt die Durchläufe danach in frei gewählten Kombinationen durch. Jede*r von euch wählt dafür eine Kategorie, z.B. Spielerin 1 Freude, Spielerin 2 Kindersendung, Spielerin 3 Actionthriller.
    ...
    → Emotion, Genre und Sprachstil müssen nicht übereinstimmen, das ist Absicht. </br>
...
!!!note "Körperlicher Auftrag"
    ...
    **Reflexionsfragen:**
    ...
    5. **Wann wurde das Gespielte plötzlich interessanter** – durch Einschränkung oder Freiheit?
    6. **Welcher Auftrag hat Beziehungen sichtbar gemacht**, die vorher unsichtbar waren?
    7. **Was hat der Körper erzählt**, was der Text nicht sagt?
    8. **Was nehmt ihr mit** als Werkzeug?
...
Wir können uns dem Raum systematisch über die Viewpoints [@bogart2025viewpoints] annähern. Dabei wird unterschieden in Architektur, Bodenmuster und Anordnung im Raum.

!!!note "Architecture/Architektur"
...
!!!note "Topography/Bodenmuster, Raumwege"
...
!!!note "Spatial Relationship/Anordnung im Raum"
...
!!!note "Tempo/Geschwindigkeit"
    Wie schnell bzw. wie langsam etwas auf der Bühne passiert.

    - Wie langsam oder schnell kann ein*e Spieler*in etwas ausführen? Wann wird es unpräzise?
...
!!!note "Kinesthetic response / die Reaktion in einer Bewegung"
...
!!!note "Sensorische Qualitäten"
    **Visuell:**
    - Spiel deinen Charakter rot, spiel deine Emotion eckiger.
    - Das Licht blendet dich.

    **Taktil:**
    - Alles, was du anfasst, ist angenehm weich.
    - Der Boden ist wackelig.
    - Objekttheater: Ein (Alltags-)Objekt spielt mit dir oder verkörpert einen Charakter.

    **Geschmack:**
    - Dein Mund brennt von Chilis.
    - Du hast Brainfreeze vom Eis.

    **Temperatur:**
    - Wie ist die Temperatur im Spielraum? Angenehm oder unangenehm?
    - Es gibt einen Luftzug. Finde heraus, woher er kommt.
    - Du bist in einer Sauna, aber es ist angenehm warm.

    **Auditiv:**
    - Du hörst Hintergrundmusik der Szene (obwohl es keine gibt).
    - Dein*e Spielpartner*in spricht zu laut (obwohl sie/er normal laut spricht).
